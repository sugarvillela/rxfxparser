...
public class Stemmer_ {
    public static void stemmer(){
        ...
        System.out.println(StringComparator.equals_r( PorterStemmer.stemAll(text1), TK.toArr(' ', text2)) );
    }
    ...
    public static void stemmer3(){
        ...
        System.out.println((r = StringComparator.equals_r( PorterStemmer.stemAll(text1), TK.toArr(' ', text2))).success() );
    ...
    public static void test(){
        System.out.println(PorterStemmer.stem("one") );
    }
}
