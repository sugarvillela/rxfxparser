...
import static langdef.Keywords.RX_MAX_RANGE;

public class WordRangeUtil {
    private static WordRangeUtil instance;
    
    private WordRangeUtil(){
    ...
    public static WordRangeUtil init(){
        return (instance == null)? (instance = new WordRangeUtil()) : instance;
    }
