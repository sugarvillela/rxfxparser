...
import compile.interfaces.IStack;
import erlog.Erlog;
 ...
 * @author Dave Swanson
 */
public abstract class Base_Stack implements IStack, ChangeNotifier, Debuggable {
    ...
    @Override
    public void persist(){//ListTableFileLoader uses
