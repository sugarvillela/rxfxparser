...
import translators.interfaces.RxWordGen;
...
public class RxWordJava implements RxWordGen {
    ...
    @Override
    public RxWordGen setNameGen(NameGenRx nameGen) {
    ...
    @Override
    public void translate(RxTreeNode root) {
    ...
    * */
    ...
    private void genWordClassBody(int lo, int hi){
        String upperCaseName = nameGen.getRx(NameGenRx.RX_WORD);
