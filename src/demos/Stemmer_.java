...
public class Stemmer_ {
    public static void stemmer(){
        ...
        System.out.println(Commons.equals( Stemmer.stemAll(text1), TK.toArr(' ', text2)) );
    }
    ...
    public static void stemmer3(){
        ...
        //System.out.println(text1);
        Commons.Result r;
        System.out.println((r = Commons.equals( Stemmer.stemAll(text1), TK.toArr(' ', text2))).success() );
